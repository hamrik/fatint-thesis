...
=== Telepítés és indítás <netlogo-setup-tutorial>
...
megnyitásához kövessük az alábbi lépéseket:
...
/ #text("Starting population", lang: "en"): A szimuláció populációjának kezdő mérete, $M_"init"$.
/ #text("Starting gene count", lang: "en"): Az egyedek genotípusának kezdő mérete, $N_"init"$.
/ #text("Use stretch method", lang: "en"): Új gének véletlenszerű generálása helyett a
...
/ #text("Measure every n steps", lang: "en"): A fajok megszámlálása sok
erőforrást igények. Ezzel az opcióval megszabható, hogy hány szimulációs lépést
követően fusson számlálás.
/ #text("Use DS", lang: "en"): A Diszjunkt-Halmaz algoritmus használata mélységi bejárás helyett a
  fajok megszámlálásakor. A modell viselkedését nem befolyásolja.

A lila dobozok nyomógombok:

/ #text("Reset", lang: "en"): Minden változót visszaállít az alapértelmezett értékekre, lásd
  @model-defaults fejezet.
/ #text("Setup", lang: "en"): Kezdőállapotba állítja a szimulációt. Törli a korábbi szimulációkból
  hátramaradt egyedeket, kezdőértékre állítja a gének számát és léthoz egy új
  populációt.
/ #text("1 step", lang: "en"): Lefuttat pontosan egy szimulációs kört.
/ #text("500 steps", lang: "en"): Lefuttat legfeljebb 500 szimulációs kört. Ha a populáció létszáma
  nullára esik, a szimuláció terminál akkor is, ha még nem futott le 500 kör.
/ #text("Go", lang: "en"): Folyamatosan futtatja a szimulációt amíg a populáció létszáma nullára nem
...
/ #text("Population", lang: "en"): A szimulációs körben részt vevő egyedek száma.
/ #text("Species count", lang: "en"): A szimulációs körben résztvevő egyedek által alkotott fajok
  száma.
/ #text("Gene count", lang: "en"): Az egyedek genotípusának elemszáma (aktivált gének száma).
...
egyszerű, a @netlogo-behaviorspace-tutorial részletezi:
...
#[
  ...
  #figure(
    ...
    caption: [A NetLogo BehaviorSpace használata],
    supplement: "Bemutató"
