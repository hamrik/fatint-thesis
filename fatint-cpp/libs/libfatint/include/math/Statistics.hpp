...
/// step.
auto
measure(size_t runs, size_t steps, const simulation::ExperimentStates& results)
  -> simulation::ExperimentResults;

/// Computes population, allele and species statistics across all runs per
/// step.
auto
measure(const simulation::ExperimentParameters& params,
        const simulation::ExperimentStates& results)
  -> simulation::ExperimentResults;

/// Computes the statistics of every experiment in the sweep.
auto
measure(const simulation::ExperimentSweepParameters& params,
